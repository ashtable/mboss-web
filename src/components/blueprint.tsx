 ...
 * public surfaces are framed this way — the waitlist
 * screens and the sign-in door in front of the
 * console — while the manage page and the console
 * itself use a plain divider border instead, which
 * is how a reader tells a private link or an
 * operator's console from the public front door.
 *
